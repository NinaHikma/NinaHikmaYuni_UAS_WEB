...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/ubg.jpg" type="image/ico" />

    <title> Komunitas Netcom UBG</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">KOMUNITAS NETCOM UBG</font></span></a>
            </center>
            </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/foto.jpg" alt="">Nina Hikma Yuni
                  </a>
